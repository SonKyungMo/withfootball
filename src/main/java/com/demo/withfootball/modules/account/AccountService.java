...
import com.demo.withfootball.modules.account.form.Notifications;
import com.demo.withfootball.modules.account.form.Profile;
...
public class AccountService implements UserDetailsService {
    ...
    private Account saveNewAccount(@Valid SignUpForm signUpForm) {
        Account account = Account.builder()
                ...
                .communityCreatedByWeb(true)
                .communityEnrollmentResultByWeb(true)
                .communityUpdatedByWeb(true)
                .build();
    ...
    public void sendSignUpConfirmEmail(Account newAccount) {
        ...
        context.setVariable("message", "위드풋볼 서비스를 사용하려면 링크를 클릭하세요.");
        context.setVariable("host", appProperties.getHost());
        String message = templateEngine.process("mail/simple-link", context);

        EmailMessage emailMessage = EmailMessage.builder()
                .to(newAccount.getEmail())
                .subject("위드풋볼, 회원 가입 인증")
                .message(message)
                .build();
