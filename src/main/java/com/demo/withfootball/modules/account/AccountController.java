...
import com.demo.withfootball.modules.account.validator.SignUpFormValidator;
...
public class AccountController {
    ...
    public String viewProfile(@PathVariable String nickname, Model model, @CurrentAccount Account account) {
        ...
        model.addAttribute("communityManagerOf",
                communityRepository.findByManagersContainingAndClosedOrderByPublishedDateTimeDesc(account, false));
        model.addAttribute("communityMemberOf",
                communityRepository.findByMembersContainingAndClosedOrderByPublishedDateTimeDesc(account, false));
